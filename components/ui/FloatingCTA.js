    ...
    <div className="fixed bottom-6 right-6 z-50 space-y-3">
      ...
      {showScrollTop && (
        <Button
          ...
          onClick={scrollToTop}
          variant="scrollTop"
          className={`${COMMON_STYLES.CIRCULAR_BUTTON} ${ANIMATIONS.SLIDE_UP}`}
      ...
      <Button
        ...
        variant="primary"
        className={`${COMMON_STYLES.CIRCULAR_BUTTON}`}
      ...
      {isExpanded && (
        <div className={`absolute bottom-16 right-0 space-y-3 ${ANIMATIONS.SLIDE_UP}`}>
          ...
          <Button
            ...
            variant="line"
            className="group flex items-center space-x-2 text-white px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
          >
