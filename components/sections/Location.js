      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8">
            {/* Google 地圖 - 優化容器減少空白 */}
            <div className="relative w-full h-[450px] lg:h-[500px] rounded-lg shadow-lg overflow-hidden">
              <iframe
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="space-y-3">
                  <a
                    ...
                    className="flex items-center justify-center w-full aurora-line text-white py-3 px-4 rounded-lg transition-all duration-300 font-semibold font-body text-sm"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center w-full aurora-instagram text-white py-3 px-4 rounded-lg transition-all duration-300 font-semibold font-body text-sm"
                  >
                    <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
